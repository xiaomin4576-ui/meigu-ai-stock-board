...
【硬纪律】① 只能基于候选列表改写,绝不虚构事件/数字;标题摘要忠于原文。② 同一事件多条只留最重要一条;地缘事件若同时影响油市(如海峡遇袭),macro 与 oil 只入一档、按主要影响归档。③ 各档内按 impact 降序。④ idx 必须是候选列表里的真实编号。⑤ 候选里够不出某档 5 条就少给,直说,不凑数。⑥ 输出保持紧凑,别加多余字段。
【候选新闻】
"""
